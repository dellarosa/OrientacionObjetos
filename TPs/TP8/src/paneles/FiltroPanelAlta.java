...
public class FiltroPanelAlta extends JPanel{
	...
	{}
	public FiltroPanelAlta(final JFrame frame)
	{
	        ...
	        public void actionPerformed(ActionEvent evt) {
	        	try {					            		
	        		...
	        		{	
	        			...
	        			filtro.setAutoparteID(autoparteBo.buscarUltimaAutoparteId());
						...
						if(filtroBo.insertarFiltro(filtro))
						{
							JOptionPane.showMessageDialog(frame, "FILTRO CREADO CORRECTAMENTE");
							
						}else
						{
							JOptionPane.showMessageDialog(frame, "FALLO CREACION FILTRO");
						}
	        		}
				} catch (MiException e) {
						throw e;					
	            } catch (Exception e) {
					throw new MiException("[CREATE FILTRO]EXCEPTION : "+e);												
				}
		        }
			});
