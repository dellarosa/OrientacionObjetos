...
public class PanelGestor {
	...
	public JPanel crearPanelOpcion(String titulo,JTextField fieldOpcion) throws MiException {
	...
	public JPanel crearPanelConFieldsEnForm(JTextField[] textFields,JLabel[] labels) throws MiException {
